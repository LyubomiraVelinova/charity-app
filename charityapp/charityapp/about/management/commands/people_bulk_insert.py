...
from charityapp.about.models import Person
    ...
    def handle(self, *args, **options):
        people_data = [
            Person(
                ...
                description='Vesela is our Assistant Coordinator for the Caps for the Future campaign - the person who is inextricably next to Silvia and helps with everything about the campaign since the second year the campaign has been held in the city. She knows how to make everything causes, extremely responsive and dedicated to helping. Her priority is causes related to the purity of nature. Her big heart does not allow her to get angry/offensive and helps her to forgive easily. She is one of those people who will always respond if needed. It always helps!'
            ),
            ...
            Person(
                ...
                description='Violina is our Cashier - the person to whom we have entrusted the responsibility for the money, she monitors the incoming and outgoing amounts. Violina is also our coordinator for the village of Zhilentsi. She is another person with a big heart with us. Her strengths are creativity, communication and persistence. Extremely responsible, organized and consistent. She knows how to organize groups of people, and she is very easy and pleasant to causes with. She is dedicated and as a bonus to all this we will also add her sense of humor. Since Violina works in a community center, it has a room for storing caps and a stage for concerts and events. Has experience in previous causes campaigns. She is interested in the world around her, knows how to see the problem and fights until she solves it.'
            ),
            ...
            Person(
                ...
                description='Lubomira is our Secretary - the person who creates and manages the documentation related to the club and its activities. She is responsible, executive and consistent until she completes what she sets out to do. Can causes with technology at an intermediate level, organize and arrange, causes in a team. He likes to challenge himself and go outside his comfort zone. Has previous experience volunteering for various causes. She will go to causes and participate in any cause, but those supporting people are her highest priority. Here\'s what else she says: "I want good to win, I hope and believe it will, but for that we need each of us to do a little good every day. Each of us is responsible for making the world a better place. a good place to live - from the smile you can give a stranger to the flower you can buy from the grandmother on the street.'
            ),
            ...
            Person(
                ...
                description='Lubomira is our blood donation coordinator - the person we can count on for one of our most humanitarian causes. She is an extremely well-intentioned and balanced person. He has time, energy, strength and a great desire to participate in the creation of a better living environment. From her causes, Lubomira has learned that before proposing a solution to something, the most important thing is to familiarize yourself with the process and not rely on assumptions. The main focus for Lubomira is the separate collection of waste, reducing our waste and the multiple use of facilities. She is responsible, extremely diligent and executive, persistent and empathetic. Able to empathize and empathize without blaming or pointing out faults. He understands well that everyone has the right to a position and accepts final opinions unconditionally. He is good at playing the role of a balancer in relationships. Lubomira is a man of action. He has experience in previous causes initiatives as a volunteer. Here\'s what else he says about himself: “The things that bring me satisfaction are mainly related to being able to help someone / feeling useful. I am willing to help with any initiatives related to the improvement of our living environment, because change starts from within us. I strongly believe that the things we do for each other gratuitously, the examples we set, are the highest expression of the human in us and keep us moving in the right direction. And a story that is my favorite and stuck in my mind from the TED talks videos: "A soldier was asked what made him go to the front, help and cover another person he had just met, risking the most precious thing - his life? And he answered: "Because he would do it for me too!"'
            ),
